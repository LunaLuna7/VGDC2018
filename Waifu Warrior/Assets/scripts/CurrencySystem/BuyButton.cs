...
public class BuyButton : MonoBehaviour {
    ...
    public void BuyItem() //On click event
    {
        ...
        {
			if (ItemShop.itemShop.itemList[i].ItemID == itemID /*&& !ItemShop.itemShop.itemList[i].bought*/ && GameManager.gameManager.CheckMoney(ItemShop.itemShop.itemList[i].ItemPrice) && PersistentDataManager.itemAmounts[i] < 5)
            {
